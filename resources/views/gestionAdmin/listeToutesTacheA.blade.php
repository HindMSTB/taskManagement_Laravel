...
@foreach($tachesNonAffectees as $tache)
    ...
    <div class="modal fade" id="detailsModalAff{{ $tache->id }}" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabelAff{{ $tache->id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="detailsModalLabelAff{{ $tache->id }}"><span style="color:black;font-weight: bold;">Détails de la tâche non affectée : </span>{{ $tache->titre }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Date d'échéance :</span></strong> {{ $tache->dateDue }}
                        ...
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">État :</span></strong> En attente d'affectation</li>
                    </ul>
                </div>
...
@foreach($tachesEnCours as $tache)
    ...
    <div class="modal fade" id="detailsModal{{ $tache->id }}" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel{{ $tache->id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="detailsModalLabel{{ $tache->id }}"><span style="color:black;font-weight: bold;">Détails de la tâche en cours : </span>{{ $tache->titre }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Affecté à :</span></strong> {{ $userName }}</li>
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Date et heure d'affectation :</span></strong> {{ $tache->dateAffectation }}</li>
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Titre :</span></strong> {{ $tache->titre }}</li>
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Description :</span></strong> {{ $tache->description }}</li>
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Priorité :</span></strong> {{ $tache->priorite }}</li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Affecté à :</span></strong> {{ $userName }}</li>
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Date et heure d'affectation :</span></strong> {{ $tache->dateAffectation }}</li>
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Marquée comme Terminée Le :</span></strong> {{ $tache->DateFin }}
                        ...
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Message Fin :</span></strong> {{ $tache->messageFin }}</li>
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Titre :</span></strong> {{ $tache->titre }}</li>
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Description :</span></strong> {{ $tache->description }}</li>
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Priorité :</span></strong> {{ $tache->priorite }}</li>
                        <li class="list-group-item"><strong><span style="color: blue; font-weight: bold;">Etat :</span></strong> {{ $tache->etat }}</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
...
<!-- affecter_tache_modal.blade.php -->

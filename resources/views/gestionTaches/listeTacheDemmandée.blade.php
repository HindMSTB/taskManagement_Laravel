            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="taches-en-cours-tab" data-toggle="tab" href="#taches-en-cours" role="tab" aria-controls="taches-en-cours" aria-selected="true">Ticket en cours de traitement</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="taches-terminees-tab" data-toggle="tab" href="#taches-terminees" role="tab" aria-controls="taches-terminees" aria-selected="false">Ticket terminées</a>
                        </li>
                    </ul>
                    <!-- Tab panes -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \Illuminate\Support\Str::limit($tache->description, 100) }} <!-- Limite la description à 100 caractères -->
                                             ...
                                             @if(strlen($tache->description) > 100) 
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Condition pour afficher "affecté" ou "non affecté" -->
                    @if($tache->user_id )
                        <p><strong><span style="color: blue; font-weight: bold;">Etat :</span></strong>  Affecté le {{ $tache->dateAffectation }}</p>
                    @else
                        <p><strong><span style="color: blue; font-weight: bold;">Etat :</span></strong> Non affecté</p>
                    @endif
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><strong><span style="color: blue; font-weight: bold;">Créé par :</span></strong> {{ $createurName }}</p>
                    <p><strong><span style="color: blue; font-weight: bold;">Date et heure de création :</span></strong> {{ $tache->dateCreation }}</p>
                    <p><strong><span style="color: blue; font-weight: bold;"> Affecté le: </span></strong> {{ $tache->dateAffectation }}</p>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><strong><span style="color: blue; font-weight: bold;">Date et heure de création :</span></strong> {{ $tache->dateCreation }}</p>
                    <p><strong><span style="color: blue; font-weight: bold;">Date d'échéance :</span></strong> {{ $tache->dateDue }}    </p>
                    <p><strong>Marquée comme Terminée Le :</strong> {{ $tache->DateFin }}
                    @if(\Carbon\Carbon::parse($tache->dateDue)->isPast())
                        <span style="color: red;">(En retard de {{ \Carbon\Carbon::parse($tache->dateDue)->diffInDays() }} jours)</span>
                    @else
                        <span>(Terminée {{ \Carbon\Carbon::parse($tache->dateDue)->diffInDays($tache->updated_at) }} jours avant la date d'échéance)</span>
            ...
            <div class="modal-content custom-content">
                ...
                <div class="modal-body">
                    ...
                    @if($modifications->isEmpty())
                        <p><strong>Création :</strong> {{ $tache->dateCreation }} </p>
                        <p><strong>Affectée:</strong> {{ $tache->dateAffectation }} </p>

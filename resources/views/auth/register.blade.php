<x-guest-layout>
    ...
    <x-slot name="logo">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="dateNaissance" value="{{ __('Date of Birth') }}" />
            ...
            <div class="mt-4">
                <x-label for="num" value="{{ __('Number') }}" />
                <x-input id="num" class="block mt-1 w-full" type="text" name="num" :value="old('num')" required autocomplete="num" />
            </div>
